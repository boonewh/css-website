            ...
            <div class="container2">
                <div class="staff">
                    ...
                    <ul>
                        ...
                        <li>Play Therapy</li>
                        <li>Art Therapy</li>
                        <li>Parenting & PCIT</li>
                        <li>Anxiety/Depression/Stress Management</li>
                        <li>Anger Management & Behavioral Issues</li>
                        <li>Sibling Therapy</li>
                        <li>Divorce Issues</li>
                        <li>Self-Esteem</li>
                        <li>Selective Mutism</li>
                        <li>School Consults</li>
                        <li>ADHD & ASD</li>
                    </ul>
                </div>
                <div class="staff">
                    ...
                    <ul>
                        ...
                        <li>Individual Therapy</li>
                        <li>Young Adult Transitions</li>
                        <li>Parenting</li>
                        <li>Anxiety/Depression/Stress Management</li>
                        <li>Anger Management & Behavioral Issues</li>
                        <li>Sibling Therapy</li>
                        <li>Complex Family Issues</li>
                        <li>Divorce Issues</li>
                        <li>Marital Counseling</li>
